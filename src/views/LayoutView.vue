<template>
  <o-layout :nav-main="navMain" :nav-top="navTop">
    <template #nav-top-left>
      <div class="branding">
        <img alt="Orion logo" class="branding__logo" src="@/assets/orion-logo-brand.svg" />
        Your Project
      </div>
    </template>
...
function simpleCallback () {
  simpleCallbackNotif
    ...
    : simpleCallbackNotif = useNotif.info({
        ...
        events: {
          'leave-end': () => simpleCallbackNotif = undefined
        }
      })
};
