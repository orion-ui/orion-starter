<template>
  ...
  <o-section v-if="state.comments.length" subtitle="Comments">
    <o-sticker v-for="comment in state.comments" :key="comment.id" :title="comment.name">
...
const state = reactive({
  comments: [] as JsonPlaceholderComment[]
})
